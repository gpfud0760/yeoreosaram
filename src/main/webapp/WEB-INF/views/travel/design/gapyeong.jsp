      ...
      <div class="container">
        <div class="row mb-4 align-items-center">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h1 class="bold" style="color:black">GAPYEONG</h1>
            <h5 class="bold" style="color:black">대한민국 가평</h5>
            <br />
          ...
          <div class="row align-items-stretch">
            ...
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h5 class="bold" style="color:black">쁘띠프랑스</h5>
                ...
                <h5 class="bold" style="color:black">TIP</h5>
                ...
                <h5 class="bold" style="color:black">아침고요수목원</h5>
