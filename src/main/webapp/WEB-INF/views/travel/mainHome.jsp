    ...
    <div class="container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url('/resources/images/bn.png');">
          ...
          <div class="carousel-item" style="background-image: url('/resources/images/driveBanner.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                <h2 class="animate__animated animate__fadeInDown">쉬는 날 가기 좋은 당일치기 드라이브 코스<span></span></h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="credits">
            Designed by <a href="/admin/adminHome">여러사람</a>
          </div>
        </div>
